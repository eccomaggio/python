...
def build_html(cl):
    ...
    elif case == ("blockquote","start"):
        head = "<blockquote><p>"
    elif case == ("blockquote","embed:start"):
        head = "</p><blockquote><p>"
    elif case == ("blockquote","cont"):
        pass
    elif case == ("blockquote","embed:end") \
        or case == ("blockquote","end") \
        or case == ("blank", "blockquote:end"):
        head = "</p></blockquote>"
    # case ("blockquote",""):
        
    elif case == ("codeblock", "start"):
        head = "<pre><code>"
    elif case == ("codeblock", "cont"):
        pass
    elif case == ("codeblock", "end") or case == ("blank","code2:end"):
        tail = "</code></pre>"
