...
"ḗ": "ē",
    ...
    for line in lines:
        # print(line)
        tmp_line = line.copy()
        tmp_line[1] = transform_macrons(tmp_line[1], drop_acutes)
...
"ū": "u:",
    ...
    for line in lines:
        # print(line)
        tmp_line = line.copy()
        tmp_line[1] = transform_macrons(tmp_line[1], add_colons)
        tmp_lines.append(tmp_line)
    return tmp_lines
...
"ū": "u",
    ...
    for line in lines:
        ...
        tmp_lemma = transform_macrons(tmp_lemma,drop_macrons)
...
"u": "ū",
    ...
    for part in tmp_line:
        if part[-1:] in ["a", "e", "i", "o", "u"]:
            part = part[:-1] + add_macrons[part[-1:]]
        tmp += part
    return tmp
