# from https://towardsdatascience.com/extracting-text-from-pdf-files-with-python-a-comprehensive-guide-9fc4003d517
# also https://github.com/g-stavrakis/PDF_Text_Extraction/blob/main/PDF_Reader.ipynb
